// Portado do elfie-web (elfie-web/src/utils/emotion.ts) — leitura best-effort do texto
// da IA para exibir um emoji de humor durante a call, sem envolver IA/backend.
...
export const EMOTIONS: Record<EmotionKey, { emoji: string; re?: RegExp }> = {
  tesao: {
    emoji: "😏",
    re: /tesão|tesud[ao]|excitad[ao]|gemid|geme[r\b]|safad[ao]|molhad[ao]|taras?[ao]|😏|🥵|🔥/i,
  },
  feliz: {
    emoji: "😄",
    re: /kk+\b|haha|rs{2,}\b|adorei|amei|que bom|que(ri|r)id[ao]|😄|😆|😂|🎉|❤️|🥰/u,
  },
...
const EMOTION_PRIORITY: EmotionKey[] = [
  "tesao",
  "surpresa",
  "brava",
  "triste",
...
export function detectEmotion(
  input: { content?: string; toolsUsed?: string[] } | undefined,
): { key: EmotionKey; emoji: string } {
